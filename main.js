...
const greek = [
  {
    ...
    ingredients: ["round barley rusk", "tomato", "teaspoon(s) vinegar, or white wine", "granulated sugar", "pinch salt and pepper", "tbsp basil", "thyme, fresh", "spring onion", "feta cheese"],
...
const german = [
  {
    ...
    intro: "Italian cuisine is bla bla bla...",
    name: "Beef Rouladen",
    ingredients: ["slices top round", "slices lean bacon", "onion", "garlic", "tbsp butter","mustard, salt, pepper, cornstratch", "cups water"],
...
},
{
    ...
    picture:"https://cdn.pixabay.com/photo/2019/03/01/15/14/roll-mops-4028046_1280.jpg"
},
{
    name: "Hoppel Poppel (Farmers Breakfast)",
    ingredients: ["leftover cooked meat", "onions, chopped", "tbsp butter", "leftover boiled potatoes", "salt and pepper", "eggs"],
...
const mexican = [
    {
      ...
      ingredients: ["lemoon sole", "lime", "cloves of garlic", "dried chipotle chillies", "dried ancho chillies", "ripe cherry tomatoes", "Lebanese cucumber", "ripe avocado"],
    ...
    },
    {
      ...
      ingredients: ["large red praawns", "tbsp smoked paprika", "vegetable oil", "mature cheddar cheese", "flour tortillas", "tbsp pickled jalapenos", "a few sprigs of fresh coriander"],
